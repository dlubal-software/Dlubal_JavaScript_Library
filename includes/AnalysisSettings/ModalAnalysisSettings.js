...
ModalAnalysisSettings.prototype.UserDefinedNumberOfModes = function (no, name, numberOfModes, solverMethod,typeOfMassMatrix, comment, params) {

};

ModalAnalysisSettings.prototype.AutomaticNumberOfModesToReachEffMass = function (no, name, effectiveModalMassFactor, solverMethod,typeOfMassMatrix, comment, params) {

};

ModalAnalysisSettings.prototype.AutomaticNumberOfModesToReachMaxFreq = function (no, name, maxNaturalFrequency, solverMethod,typeOfMassMatrix, comment, params) {
