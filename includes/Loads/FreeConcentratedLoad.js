...
* @return	{Object}	Created free oncentrated load
*/
                              ...
                              params)
{
	...
	*/
	...
	{
		this.load = createBaseLoad("Free_Concentrated_Load", no, load_case, surfaces, comment, params);
		this.load = setLoadParameters(this.load, free_concentrated_loads.LOAD_TYPE_FORCE, load_values);
	...
	*/
	...
	{
		this.load = createBaseLoad("Free_Concentrated_Load", no, load_case, surfaces, comment, params);
		this.load = setLoadParameters(this.load, free_concentrated_loads.LOAD_TYPE_MOMENT, load_values);
		this.load = setCommonFreeLoadsValues(this.load, load_projection, load_direction, load_acting_region_from, load_acting_region_to);
	...
	*/
	var setLoadParameters = function(load,
									 load_type,
									 load_values)
	{
