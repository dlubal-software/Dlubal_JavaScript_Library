...
member_imperfection.InitialSway(undefined, localIC, [member.GetNo()]);
...
member_imperfection.InitialSway(undefined, localIC, [member.GetNo()]);
member_imperfection.ANSI_GRAVITY_LOAD(lc8.GetNo(), 0.006, "ASD");
member_imperfection.InitialSway(undefined, localIC, [member.GetNo()]);
member_imperfection.CSA_CURRENT(0.02);
member_imperfection.InitialSway(undefined, localIC, [member.GetNo()]);
member_imperfection.CSA_GRAVITY_LOAD(lc7.GetNo(), 0.03);
member_imperfection.InitialSway(undefined, localIC, [member.GetNo()]);
member_imperfection.GB_50017_2017_CURRENT(0.03, 1.5, 4);
member_imperfection.InitialSway(undefined, localIC, [member.GetNo()]);
member_imperfection.GB_50017_2017_GRAVITY_LOAD(lc6.GetNo(), 0.09, 3);
member_imperfection.InitialBow(undefined, localIC, [member.GetNo()], coordinate_system.no);
member_imperfection.Relative(1.5);
member_imperfection.InitialBow(undefined, localIC, [member.GetNo()], coordinate_system.no);
member_imperfection.Absolute(0.25);
member_imperfection.InitialBow(undefined, localIC, [member.GetNo()]);
member_imperfection.InitialBow_EN_1993_1_1("PLASTIC");
member_imperfection.InitialBow(undefined, localIC, [member.GetNo()], "LOCAL", "LOCAL_Y_NEGATIVE");
member_imperfection.EN_1995_1_1(30);
member_imperfection.InitialBow(undefined, localIC, [member.GetNo()], "LOCAL", "LOCAL_Z_NEGATIVE");
member_imperfection.EN_1999_1_1();  // With PLASTIC default design type
member_imperfection.InitialBow(undefined, localIC, [member.GetNo()]);
member_imperfection.InitialBow_ANSI_CURRENT(0.005);
member_imperfection.InitialBow(undefined, localIC, [member.GetNo()]);
member_imperfection.InitialBow_ANSI_GRAVITY_LOAD(lc6.GetNo(), 0.95);
member_imperfection.InitialBow(undefined, localIC, [member.GetNo()], "LOCAL", "LOCAL_Z_NEGATIVE", undefined, "Comment1");
...
member_imperfection.InitialBowAndCriterion(undefined, localIC, [member.GetNo()], "PRINCIPAL", "V_NEGATIVE");
member_imperfection.Relative(1.5, "DIN_18800");
member_imperfection.InitialBowAndCriterion(undefined, localIC, [member.GetNo()], "PRINCIPAL", "V_NEGATIVE");
member_imperfection.Relative(1.5, "DEFINE", 2.5);
member_imperfection.InitialBowAndCriterion(undefined, localIC, [member.GetNo()], "PRINCIPAL", "V_NEGATIVE", true);  // With reference to list of members
...
member_set_imperfection.InitialSway(undefined, localIC, [memberSet.GetNo()]);
...
member_set_imperfection.InitialSway(undefined, localIC, [memberSet.GetNo()]);
member_set_imperfection.ANSI_GRAVITY_LOAD(lc8.GetNo(), 0.006, "ASD");
member_set_imperfection.InitialSway(undefined, localIC, [memberSet.GetNo()]);
member_set_imperfection.CSA_CURRENT(0.02);
member_set_imperfection.InitialSway(undefined, localIC, [memberSet.GetNo()]);
member_set_imperfection.CSA_GRAVITY_LOAD(lc7.GetNo(), 0.03);
member_set_imperfection.InitialSway(undefined, localIC, [memberSet.GetNo()]);
member_set_imperfection.GB_50017_2017_CURRENT(0.03, 1.5, 4);
member_set_imperfection.InitialSway(undefined, localIC, [memberSet.GetNo()]);
member_set_imperfection.GB_50017_2017_GRAVITY_LOAD(lc6.GetNo(), 0.09, 3);
member_set_imperfection.InitialBow(undefined, localIC, [memberSet.GetNo()], coordinate_system.no);
member_set_imperfection.Relative(1.5);
member_set_imperfection.InitialBow(undefined, localIC, [memberSet.GetNo()], coordinate_system.no);
member_set_imperfection.Absolute(0.25);
member_set_imperfection.InitialBow(undefined, localIC, [memberSet.GetNo()]);
member_set_imperfection.InitialBow_EN_1993_1_1("PLASTIC");
member_set_imperfection.InitialBow(undefined, localIC, [memberSet.GetNo()], "LOCAL", "LOCAL_Y_NEGATIVE");
member_set_imperfection.EN_1995_1_1(30);
member_set_imperfection.InitialBow(undefined, localIC, [memberSet.GetNo()], "LOCAL", "LOCAL_Z_NEGATIVE");
...
member_set_imperfection.InitialBow(undefined, localIC, [memberSet.GetNo()]);
member_set_imperfection.InitialBow_ANSI_GRAVITY_LOAD(lc6.GetNo(), 0.95);
member_set_imperfection.InitialBow(undefined, localIC, [memberSet.GetNo()], "LOCAL", "LOCAL_Z_NEGATIVE", "Comment1");
...
member_set_imperfection.InitialBowAndCriterion(undefined, localIC, [memberSet.GetNo()], "PRINCIPAL", "V_NEGATIVE");
member_set_imperfection.Relative(1.5, "DIN_18800");
member_set_imperfection.InitialBowAndCriterion(undefined, localIC, [memberSet.GetNo()], "PRINCIPAL", "V_NEGATIVE");
member_set_imperfection.Relative(1.5, "DEFINE", 2.5);
member_set_imperfection.InitialBowAndCriterion(undefined, localIC, [memberSet.GetNo()], "PRINCIPAL", "V_NEGATIVE", true);  // With reference to list of members
