...
var lc = new LoadCase();
lc.StaticAnalysis(1, "Static analysis", staticAnalysis.Settings.no, "PERMANENT_G", [true, 0, 0, 1.0]);
var lc2 = new LoadCase();
lc2.StaticAnalysis(2, "Static analysis", staticAnalysis.Settings.no, "PERMANENT_G", [true, 0, 0, 1.0]);
var lc3 = new LoadCase();
lc3.StaticAnalysis(3, "Static analysis", staticAnalysis.Settings.no, "PERMANENT_G", [true, 0, 0, 1.0]);
var lc4 = new LoadCase();
lc4.StaticAnalysis(4, "Static analysis", staticAnalysis.Settings.no, "NONE_NONE", [true, 0, 0, 1.0]);
var lc5 = new LoadCase();
lc5.StaticAnalysis(5, "Static analysis", staticAnalysis.Settings.no, "PERMANENT_G", [true, 0, 0, 1.0]);
var lc6 = new LoadCase();
lc6.StaticAnalysis(6, "Static analysis", staticAnalysis.Settings.no, "PERMANENT_G", [true, 0, 0, 1.0]);
var lc7 = new LoadCase();
lc7.StaticAnalysis(7, "Static analysis", staticAnalysis.Settings.no, "PERMANENT_G", [true, 0, 0, 1.0]);
var lc8 = new LoadCase();
lc8.StaticAnalysis(8, "Static analysis", staticAnalysis.Settings.no, "PERMANENT_G", [true, 0, 0, 1.0]);
...
member_imperfection.ReferenceToListOfMembers();
...
member_imperfection2.RefereDistanceToTheMemberEnd();
...
member_imperfection3.ImperfectionOverTotalLength(false);
