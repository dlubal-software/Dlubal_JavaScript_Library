...
member_imperfection.InitialSway(undefined, localIC.no, [member.No()]);
...
member_imperfection.InitialBow(undefined, localIC.no, [member.No()], coordinate_system.no);
member_imperfection.Relative(1.5);
member_imperfection.InitialBow(undefined, localIC.no, [member.No()], coordinate_system.no);
member_imperfection.Absolute(0.25);
member_imperfection.InitialBow(undefined, localIC.no, [member.No()]);
member_imperfection.InitialBow_EN_1993_1_1("PLASTIC");
member_imperfection.InitialBow(undefined, localIC.no, [member.No()], "LOCAL", "LOCAL_Y_NEGATIVE");
member_imperfection.EN_1995_1_1(30);
member_imperfection.InitialBow(undefined, localIC.no, [member.No()], "LOCAL", "LOCAL_Z_NEGATIVE");
...
member_imperfection.InitialBow(undefined, localIC.no, [member.No()], "LOCAL", "LOCAL_Z_NEGATIVE", undefined, "Comment1");
member_imperfection.CSA_CURRENT(1250);
member_imperfection.InitialBow(undefined, localIC.no, [member.No()]);
member_imperfection.CSA_GRAVITY_LOAD(lc7.GetLoadCaseNo(), 0.03);
//member_imperfection.InitialBow(undefined, localIC.no, [member.No()]);
//member_imperfection.GB_50017_2017(0); Bug?
member_imperfection.InitialBowAndCriterion(undefined, localIC.no, [member.No()], "PRINCIPAL", "V_NEGATIVE");
