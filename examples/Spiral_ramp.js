...
th.Uniform(1, "Ramp", "", [thickness_1],"", {"material": material});
th.Uniform(2, "Walls", "", [thickness_2],"", {"material": material});

// Create section 
var column = Section(undefined, 'CIRCLE_M1 300', material);
...
// Create members
var mem = new Member();
mem.BeamByLine(1, 32, 0, "", "", "", "", "", {"section_start": column});
mem.BeamByLine(2, 33, 0, "", "", "", "", "", {"section_start": column});
mem.BeamByLine(3, 34, 0, "", "", "", "", "", {"section_start": column});
mem.BeamByLine(4, 35, 0, "", "", "", "", "", {"section_start": column});
